...
## Using programmatically with Puppeteer

This is the same example as above, but it uses Puppeteer instead of `chrome-launcher`. It will test the page in the same tab opened by Puppeteer.
