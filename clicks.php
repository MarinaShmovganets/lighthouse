...
<html lang="De"><head>
        ...
        <meta name="verification" content="5beb210f277740818ab1e9c19d5e8a6a" />
                ...
                <title>Klickübersicht</title>
        <meta name="keywords" content="clicks meta keywords" />
        <meta name="description" content="clicks meta description" />
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta property="og:title" content=""/>
        <meta property="og:description" content=""/>
        <meta property="og:image" content=""/>
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <link rel="alternate" hreflang="De" href="https://www.cashbackdeals.de/user/clicks.php" />

        
        <link rel="canonical" href="https://www.cashbackdeals.de/user/clicks.php"/>
        ...
        <script>
            ...
            if ($('#timer').length > 0) {
            var timer;
            var compareDate = new Date('Thu May 09 2019 00:00:00 +0000');
            compareDate.setDate(compareDate.getDate() + parseInt('3'));
        ...
        <style>
            body{background-image:none;background-color: #f2eeeb;}
            .main_banner{display: none;}
            .special-banner{position: fixed;width: 180px;top: 60px}
            .special-banner.left-banner{ margin-left: -60px;}
            .special-banner.right-banner{ margin-left: 1120px; }
            @media (max-width: 1024px){ .special-banner{display: none;} }
            @media(max-width:1599px ){.banner-lg{ display: none; }}
            @media(min-width:1600px ){.banner-sm{display: none;} 
                                      .special-banner{width: 300px;} 
                                      .special-banner.left-banner {margin-left: -180px;}}
            @media(min-width:1900px ){.special-banner{width: 460px;} 
                                      .special-banner.left-banner {margin-left: -340px;}}
            </style>
            
                                  
        
     <style>
            .leftBanner.main_banner, .rightBanner.main_banner {
                margin-top: 52px;
                height: 560px;
            }
            .SkyScraper-btn {
            ...
            .SkyScraper-btn.top-btn{
                top:10px;
            }
            .SkyScraper-btn.mid-btn{
                top: 48%;
            }
            .SkyScraper-btn.bottom-btn{
                bottom:10px;
            }
        </style>
    ...
    <script src="/general.assets/js/fb_login.js" type="text/javascript"></script> 
        <body class="logged-user">
            ...
            <!-- Takeover Different banner code start -->
                        <div class="special-banner left-banner">
                                                                                                                                <a class="various" href="#inline_store_visit" onClick="loginFancyPopUP({cashback: '10,00%', storeName: 'Norton Antivirus', urlKey: 'norton-antivirus', imgUrl: 'https://static.orangebuddies.nl/image/stores/22183.gif', itemId: '0', bannerId: '700', isCbkDay: '0', channel: 'TOB'})" title="Norton Antivirus"><img src="https://static.orangebuddies.nl/image/advertisingbanners/700_ads_0.jpg" class="banner-sm"/></a>
                <a class="various" href="#inline_store_visit" onClick="loginFancyPopUP({cashback: '10,00%', storeName: 'Norton Antivirus', urlKey: 'norton-antivirus', imgUrl: 'https://static.orangebuddies.nl/image/stores/22183.gif', itemId: '0', bannerId: '700', isCbkDay: '0', channel: 'TOB'})" title="Norton Antivirus"><img src="https://static.orangebuddies.nl/image/advertisingbanners/700_adl_0.jpg" class="banner-lg"/></a>
                                            </div>
            ...
            <div id="top-container" class="clearfix">
                <div id="top"> 
                    <span class="top-usp">
                            ...
                            <A HREF="https://www.cashbackdeals.de/shops/theme/Muttertag">Hier findest Du die besten Geschenkideen für Deine Mama!</A> 
                    ...
                    <div id="timer">
                        ...
                        <span><a href="javascript:void(0);" class="t-user active"><i class="fa fa-globe" aria-hidden="true"></i>  </i></a>
                            ...
                            <div>
                                <div class="column">
                                    <ul>
                                        <li><a href="/user/cashback.php"><i class="fa fa-database"></i> Saldo 19,255</a></li>
                                        <li><a href="/user/welcome.php"><i class="fa fa-pencil"></i> Mein Konto</a></li>
                                        <li><a href="/user/cashmail.php"><i class="fa fa-envelope"></i> Posteingang (61)</a></li>
            ...
            <div id="container" class="clearfix">
                <div id="menu">
                    ...
                    <ul>                
                        <li><a  href="/shops/shops.php?url_key=all">Shoppen</a>
                            <div>
                                    ...
                                    <h3>
                                        <a href="/shops/shops.php?url_key=all">Shoppen</a>
                                            ...
                                            <a href="/cashback/na-kd-com.php">NA-KD.com</a>
                                                                                ...
                                                                                <li>
                                            <a href="/cashback/mega-casino.php">Mega Casino</a>
                                        </li>
                                                                                <li>
                                            <a href="/cashback/jbl-com.php">JBL.com</a>
                                        </li>
                                                                                <li>
                                ...
                                <div class="nav-column">
                                    ...
                                    <ul>
                                                                                                                        <li>
                                            <a href="/cashback/elkline-de.php">Elkline</a>
                                        </li>
                                                                                <li>
                                            <a href="/cashback/drmartens-com-de.php">Dr. Martens</a>
                                        </li>
                                                                                <li>
                                            <a href="/cashback/ulla-popken.php">Ulla Popken</a>
                                        </li>
                                                                                <li>
                                            <a href="/cashback/shirtlabor.php">Shirtlabor</a>
                                        </li>
                                                                                <li>
                                            <a href="/cashback/verwoehnwochenende-de.php">Verwoehnwochenende.de</a>
                                        </li>
                                                                                <li>
                                            <a href="/cashback/contorion.php">Contorion</a>
                                        </li>
                                                                                <li>
                                            <a href="/cashback/motea-com-de.php">Motea</a>
                                        </li>
                                                                                <li>
                                            <a href="/cashback/sommerkind.php">Sommerkind</a>
                                        </li>
                                                                                <li>
                                            <a href="/cashback/colvinco.php">Colvinco</a>
                                        </li>
                                                                                <li>
                                            <a href="/cashback/parfum-s-club.php">Parfum's Club</a>
                                        </li>
                        ...
                        <li class="download-app-menu"><a class="app-icon"  href="/static/toolbar.php"><div class="alert-bar"><span>Alert</span></div>
                                                                        ...
                                                                        <li class="menu-blue"><a href="/shops/theme/Muttertag">Muttertag</a></li>
                                                                    </ul>
                </div>
                <!--- responseiv menu-->
                    ...
                    <div class="burger_menu">
                        <ul class="cd-accordion-menu">
                            ...
                            <li> <a href="/blog/" target="_self">Blog</a> </li>
                                                                                    <li><a href="/shops/theme/Muttertag" target="_self">Muttertag</a></li>
                ...
                <div id="main">
                  ...
                  <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                    ...
                    </li><li>Klickübersicht</li></ol> </div>
<div id="toptabs">
    <ul> 
        <li >
        ...
        <li id="current"><a href="/user/clicks.php" title="Klickübersicht" ><span>Klickübersicht</span></a></li>
...
<h2 class="new-heading">        Klickübersicht
    </h2>
<div class="click_overview">
    <div class="click_heading"> <span class="click_shop">Shop</span> <span> Plattform</span> <span> IP-Adresse</span> <span> Datum</span> <span> Uhrzeit</span> </div>
                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/santander-consumer-bank-de.php"><img src="https://static.orangebuddies.nl/image/stores/96620.jpg" alt="Santander Consumer Bank" width="75" height="33"></a></span> <span class="tdfocused">                             android
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">11-05-2019</span> <span class="tdfocused">19:22:48</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/preisboerse24-de.php"><img src="https://static.orangebuddies.nl/image/stores/91728.jpg" alt="preisboerse24" width="75" height="33"></a></span> <span class="tdfocused">                             android
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">11-05-2019</span> <span class="tdfocused">09:40:41</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/tomtop-com.php"><img src="https://static.orangebuddies.nl/image/stores/38213.jpg" alt="TomTop.com" width="75" height="33"></a></span> <span class="tdfocused">                             web
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">10-05-2019</span> <span class="tdfocused">23:22:43</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/tomtop-com.php"><img src="https://static.orangebuddies.nl/image/stores/38213.jpg" alt="TomTop.com" width="75" height="33"></a></span> <span class="tdfocused">                             web
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">10-05-2019</span> <span class="tdfocused">22:47:54</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/tomtop-com.php"><img src="https://static.orangebuddies.nl/image/stores/38213.jpg" alt="TomTop.com" width="75" height="33"></a></span> <span class="tdfocused">                             web
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">10-05-2019</span> <span class="tdfocused">22:14:07</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/tomtop-com.php"><img src="https://static.orangebuddies.nl/image/stores/38213.jpg" alt="TomTop.com" width="75" height="33"></a></span> <span class="tdfocused">                             web
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">10-05-2019</span> <span class="tdfocused">21:37:39</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/deutsche-postbank.php"><img src="https://static.orangebuddies.nl/image/stores/8164.jpg" alt="Postbank" width="75" height="33"></a></span> <span class="tdfocused">                             web
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">09-05-2019</span> <span class="tdfocused">20:18:50</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/o2-de.php"><img src="https://static.orangebuddies.nl/image/stores/90640.jpg" alt="O2" width="75" height="33"></a></span> <span class="tdfocused">                             web
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">09-05-2019</span> <span class="tdfocused">20:10:42</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/o2-de.php"><img src="https://static.orangebuddies.nl/image/stores/90640.jpg" alt="O2" width="75" height="33"></a></span> <span class="tdfocused">                             web
                                 </span> <span nowrap="nowrap" class="tdfocused">2.247.246.223</span> <span class="tdfocused">08-05-2019</span> <span class="tdfocused">16:02:27</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/payvip-de.php"><img src="https://static.orangebuddies.nl/image/stores/100372.jpg" alt="payVIP MasterCard Gold" width="75" height="33"></a></span> <span class="tdfocused">                             web
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">06-05-2019</span> <span class="tdfocused">14:03:15</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/lieferando-de.php"><img src="https://static.orangebuddies.nl/image/stores/87428.jpg" alt="Lieferando.de" width="75" height="33"></a></span> <span class="tdfocused">                             android
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">05-05-2019</span> <span class="tdfocused">19:18:26</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/amazon-prime-2.php"><img src="https://static.orangebuddies.nl/image/stores/82657.jpg" alt="Amazon Prime" width="75" height="33"></a></span> <span class="tdfocused">                             web
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">04-05-2019</span> <span class="tdfocused">20:59:55</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/idealo.php"><img src="https://static.orangebuddies.nl/image/stores/104339.jpg" alt="idealo" width="75" height="33"></a></span> <span class="tdfocused">                             web
                                 </span> <span nowrap="nowrap" class="tdfocused">37.201.7.139</span> <span class="tdfocused">04-05-2019</span> <span class="tdfocused">20:51:48</span> </div>
                                    
            <div class="click_details"> <span class="click_shop"> <a href="/cashback/payvip-de.php"><img src="https://static.orangebuddies.nl/image/stores/100372.jpg" alt="payVIP MasterCard Gold" width="75" height="33"></a></span> <span class="tdfocused">                             android
                                 </span> <span nowrap="nowrap" class="tdfocused">{"status":"FAILED","</span> <span class="tdfocused">20-04-2019</span> <span class="tdfocused">22:01:38</span> </div>
                     </div>
                    <div class="pages" id="Pagination"> <div ><span class="disabled"><< letzte</span><span class="current">1</span><a href=?page=2/>2</a><a href=?page=3/>3</a><a href=?page=4/>4</a><a href=?page=5/>5</a><a href='#'>...</a><a href=?page=16>16</a><a href=?page=17>17</a><a href=?page=2> nächste >></a></div> </div>
                   
<script type="text/javascript">
    var catsarray = [];
    $(document).ready(function () {
        $(".fcats").on('click', function () {
            var checked = $(this).attr('checked');
            var clickedId = $(this).val();
            if (checked) {
                var faction = 'addCampFavCats';
            } else {
                var faction = 'remCampFavCats';
            }
            $.post('/ajax/add_user_fav.php', {'faction': faction, 'clickedId': clickedId}, function (data) {
...
//alert('Data was saved in db!');
    ...
    <div class="banner-overlay">
        <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '200,00 ', storeName: 'O2', urlKey: 'o2-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/90640.jpg', itemId: '0', bannerId: '42182', isCbkDay: '1'})"> 
                        <span class="banner-CC-tag">ERHALTE BIS ZU 200,00 CASHCOINS BEI O2 </span>
                          
            <img src="https://static.orangebuddies.nl/image/banners/42182-Normal.jpg" alt="O2">
                    </a> 
    </div>
...
<div id="footer">
 ...
 <!-- Takeover different banner code start -->
              <div class="special-banner right-banner">
                                                                                                             <a class="various" href="#inline_store_visit" onClick="loginFancyPopUP({cashback: '10,00%', storeName: 'Norton Antivirus', urlKey: 'norton-antivirus', imgUrl: 'https://static.orangebuddies.nl/image/stores/22183.gif', itemId: '0', bannerId: '700', isCbkDay: '0', channel: 'TOB'})" title="Norton Antivirus"><img src="https://static.orangebuddies.nl/image/advertisingbanners/700_ads_1.jpg" class="banner-sm"/></a>
                    <a class="various" href="#inline_store_visit" onClick="loginFancyPopUP({cashback: '10,00%', storeName: 'Norton Antivirus', urlKey: 'norton-antivirus', imgUrl: 'https://static.orangebuddies.nl/image/stores/22183.gif', itemId: '0', bannerId: '700', isCbkDay: '0', channel: 'TOB'})" title="Norton Antivirus"><img src="https://static.orangebuddies.nl/image/advertisingbanners/700_adl_1.jpg" class="banner-lg"/></a>
                                    </div>
...
<!-- PeanutLabs Alert Ends -->
        ...
        <script type="text/javascript">
         ...
         function b64EncodeUnicode(str) {
            ...
            function fulcrumReload(){
                location.reload();
            }
             function fulcrumSurveySent(user_id, survey_number, site_id){

                 var cookieNameValue = 'fc-'+user_id+'-'+survey_number+'-'+site_id;
                 var isCookie = getFcCookie(cookieNameValue);
                 if (isCookie != "") {
                     console.log("AlreadyClicked " + isCookie);
                     return false;
                 } else {
                         var d = new Date();
                         d.setTime(d.getTime() + (1*24*60*60*1000));
                         var expires = "expires="+ d.toUTCString();
                         document.cookie = cookieNameValue + "=" + cookieNameValue + ";" + expires + ";path=/";
                ...
                if (typeof myObj.blogId !== "undefined" && myObj.blogId != 0) {
                    ...
                    //End Only for website banners
                      if (typeof myObj.themeId !== "undefined" && myObj.themeId != 0)
                        ...
                        if (typeof myObj.notify !== "undefined" && myObj.notify != 0)
                           landingLink += '&notify=1';
           ...
           //  alert(type);
             //alert(cashback + type);
                ...
                // already visited store script
                 var vistedKeys = [];
                                                       vistedKeys.push("idealo");
                                      vistedKeys.push("amazon-prime-2");
                                      vistedKeys.push("o2-de");
                                      vistedKeys.push("deutsche-postbank");
                                      vistedKeys.push("tomtop-com");
            ...
            $(document).ready(function ($) {
                ...
                $('form').each(function (index, value) { 
                    if(value.name != 'sort-shopsForm' && value.name != 'itune-form'  && value.name != 'cadeous-cards' ) {
                        token = 'b9c37e03a8f7442784404c3711845cd38ed2c0d5';
                        $(this).append('<input type="hidden" name="csrf_token" value="' + token + '"><input type="hidden" name="csrf_page" value="clicks">');
                    }
                });
...
*/
       ...
       /*   if (obj.formId && obj.formId === "cadeaus_checkout")
        ...
        if(typeof obj.isPayPalForm !== "undefined" && obj.isFBUser == 1){
                ...
                if(obj.isRequestPage == true){
                 ...
                 if(obj.passwordNewflow !== "undefined" && obj.passwordNewflow == 1){
                    var txt_login_pass = "Wachtwoord vergeten? <a href='/user/forgot-password.php'>Klik hier</a>";
        ...
        <script>
            ...
            /* Add Class to Body when timer exists*/
            if ($('#top-container').find('#timer').length > 0) {
                $('body').addClass('has-top-timer');
            }
...
<div style="display:none;"> <a class="various"  href="#inline_store_reg" id="regPop">visit</a> <a class="various"  href="#inline_store_visit" id="visitPop">register</a>
    ...
    <input type="hidden" id="store_full_desc" value="Achtung:<br /> Bestelle direkt und besuche während der Bestellung <b>keine</b> anderen Websites, sonst erhalten wir keine Vergütung von //store_name und können dir auch keine CashCoins geben. Denke daran vor jeder Bestellung die Browser-Cookies zu löschen.<br /> Dein Ankauf wird innerhalb von 48 Stunden in deinem Konto sichtbar." />
            ...
            <div class="popup-content-padding clearfix">
                        ...
                        <div class="content">
                            <section id="section-1">
                                ...
                                <form action="https://www.cashbackdeals.de/user/register.php" method="post" enctype="application/x-www-form-urlencoded" name="form1" target="_self"><!-- please remove ID or rename it -->
                                    ...
                                    <input name="ReturnUrl" type="hidden" id="ReturnUrlReg" class="ReturnUrl" value="/user/clicks.php" />
                                </form>
                            ...
                            <section id="section-2">
                                ...
                                <form action="https://www.cashbackdeals.de/user/login.php" method="post" enctype="application/x-www-form-urlencoded" name="form2" target="_self"><!-- please remove ID or rename it -->
                                    ...
                                    <input name="ReturnUrl" type="hidden" id="ReturnUrlLoginPopup" class="ReturnUrl" value="/user/clicks.php" />
                                </form>
                ...
                <div class="popup-content-left">
                    <span class="popup-advantages">
                        ...
                        <ul>
                            <li> 10 Wege, Cash zu verdienen</li> <li> 7,50 CashCoins geschenkt</li> <li> Höchstes Cashback</li> <li> 3183 Webshops</li> <li> 100% gratis</li>
                        </ul>
                    </span>
                </div>
...
<div id="inline_cashout_auth" style="display:none;">
    <div class="EmailPopup">
        ...
        <div class="signup-form-pass SmTxt">Passwort ändern? <a href="/user/forgot-password.php">Klicke hier</a></div>
        <div>
