...
* **[laravel-lighthouse](https://github.com/adityadees/laravel-lighthouse)** - Package for laravel framework which can help run Google Lighthouse to audit websites. The audit results that have been completed will be saved automatically in your server directory.
