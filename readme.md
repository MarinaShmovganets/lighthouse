...
* **[lighthouse-jest-example](https://github.com/justinribeiro/lighthouse-jest-example)** - gathers performance metrics via Lighthouse and tests results with Jest; uses Puppeteer to start up come with Chrome with network emulation settings defined by WebPageTest.
