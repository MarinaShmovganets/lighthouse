...
* **[lighthouse-monitor](https://github.com/verivox/lighthouse-monitor)** - Lighthouse for companies. Run profiles against all your URLs. Send metrics anywhere you want, save all reports with automatic data retention, compare any two results in a WebUI.  
