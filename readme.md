...
* **[lighthouse-hue](https://github.com/ebidel/lighthouse-hue)** - set the color of Philips Hue lights based on a Lighthouse score
   * **[lighthous-magic-light](https://github.com/manekinekko/lighthouse-magic-light/tree/web-ble)** set the color of the MagicLight Bluetooth Smart Light Bulb based on Lighthouse score
