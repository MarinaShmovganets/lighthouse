...
const PerformanceBudgetAudit = require('../../audits/performance-budget.js');
...
describe('Performance: Resource budgets audit', () => {
  ...
  describe('with a budget.json', () => {
    ...
    it('warns of audit id being renamed to resource-budget', async () => {
      const result = await PerformanceBudgetAudit.audit(artifacts, context);
      expect(result.warnings[0]).toBeDisplayString(`The id for this audit will be changing `
      + `from 'performance-budget' to 'resource-budget'. Update your scripts accordingly.`);
    });
  ...
  describe('budget selection', () => {
    ...
    describe('without a matching budget', () => {
      ...
      it('does not warn of audit id being renamed to resource-budget', async () => {
        const result = await PerformanceBudgetAudit.audit(artifacts, context);
