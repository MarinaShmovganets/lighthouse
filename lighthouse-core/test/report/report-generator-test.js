  ...
  describe('#generateReport', () => {
    ...
    it('creates CSV for results', async () => {
      ...
      expect(lines.slice(0, 3).join('\n')).toMatchInlineSnapshot(`
        ...
        \\"http://localhost:10200/dobetterweb/dbw_tester.html\\",\\"http://localhost:10200/dobetterweb/dbw_tester.html\\",\\"Performance\\",\\"performance-score\\",\\"Overall Performance Category Score\\",\\"numeric\\",\\"0.58\\"
