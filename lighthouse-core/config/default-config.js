...
const UIStrings = {
  ...
  /** Title of the Accessibility category of audits. Accessibility contains audits focused on making web content accessible to users with disabilities. Also used as a label of a score gauge; try to limit to 20 characters. */
  a11yCategoryTitle: 'Accessibility',
  /** Description of the Accessibility category. This is displayed immediately under the Accessibility title element. No character length limits. 'improve the accessibility of your web app' becomes link text to additional documentation. */
  ...
  /** Description of the Accessibility manual checks category. This is displayed above the manual checks section of the Accessibility category. No character length limits. 'conducting an accessibility review' becomes link text to additional documentation. */
