...
if (require.main === module) {
  ...
  if (collisions > 0) {
    ...
    assert.equal(collisions, 30, `The number of duplicate strings have changed, update this assertion if that is expected, or reword strings. Collisions: ${collisionStrings}`);
  }
