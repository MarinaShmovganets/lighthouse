...
class ImageElementsSnapshot extends FRGatherer {
  ...
  async collectExtraDetails(driver, elements, indexedNetworkRecords) {
    ...
    for (const element of elements) {
      ...
      const networkRecord = indexedNetworkRecords && indexedNetworkRecords[element.src];
   ...
   */
  async _getArtifact(context, indexedNetworkRecords) {
...
module.exports = ImageElementsSnapshot;
