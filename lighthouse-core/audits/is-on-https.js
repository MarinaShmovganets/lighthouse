...
const UIStrings = {
  ...
  description: 'All sites should be protected with HTTPS, even ones that don\'t handle ' +
      ...
      'where some resources are loaded over HTTP despite the initial request being served over HTTPS. ' +
      'HTTPS prevents intruders from tampering with or passively listening ' +
